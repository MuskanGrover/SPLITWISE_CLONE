...
export default function Home() {
  ...
  <section  id="features"className="bg-gray-50 py-20">
    <div className="container mx-auto px-4 md:px-6 text-center">
      ...
      Our platform provides all the tools you need to handle shared expenses with ease.</p>
...
<section  id="how-it-works"className="py-20">
        ...
        <Card key={name}>
          <CardContent className="space-y-4 p-6">
              ...
              <div className="flex items-center space-x-3">
                <Avatar>
                  <AvatarImage className="h-18 w-18 rounded-full"src={image} alt={name} />
  ...
  <div className="container mx-auto px-4 md:px-6 text-center space-y-6">
    <h2 className="text-3xl font-extrabold trcking-tight md:text-4xl text-white">
      Ready to simplify expense sharing?
    </h2>
    <p className="mx-auto max-w-[600px] text-green-100 md:text-xl/relaxed">
    Join thousands of users who have made splitting expenses stress-free.</p>
  ...
  <footer className= "bg-gray-100 h-20 text-center text-sm text-gray-800 py-6 border-t mt-10">
  <p>Split with <span className="text-red-500">❤️</span></p>
</footer>
  </div>
  );
}
